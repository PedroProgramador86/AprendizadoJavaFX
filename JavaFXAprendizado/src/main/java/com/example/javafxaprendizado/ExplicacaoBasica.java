...
public class ExplicacaoBasica extends Application{
    ...
    public void start(Stage stagePrimary) throws Exception {
        //            ^^^^^^^^^^^^^^^^^^
        // 3.1 Podemos definir aqui como será chamado o "Palco" (Stage) do start (Que é o primeiro elemento de uma aplicação java)

        // 6. Criamos um grupo para organizar todos os "nós" diferentes (que são os componentes)
        Group root = new Group();

        // 7. Criamos a "cena" (Scene) (Que é o segundo elemento de uma aplicação java) e em seguida adicionamos esse
        // "grupo de nós" criado anteriormente na "cena"
